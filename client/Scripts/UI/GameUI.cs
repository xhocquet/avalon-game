...
namespace Meesles.Avalon {
  public partial class GameUI : CanvasLayer, IViewHud {
    ...
    private void OnCrystalDestroyed(CrystalDestroyedEvent evt) => ShowAnnouncement("Crystal Destroyed!");

    private void OnTurretDestroyed(TurretDestroyedEvent evt) => ShowAnnouncement("Turret Destroyed!");
    ...
    private void SetupAnnouncement() {
      ...
      _announceLabel.AddThemeColorOverride("font_outline_color", new Color(0f, 0f, 0f, 1f));
    ...
    private void ShowAnnouncement(string text) {
      ...
      _announceLabel.Modulate = new Color(1f, 1f, 1f, 1f);
