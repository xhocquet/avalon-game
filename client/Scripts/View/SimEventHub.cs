...
namespace Meesles.Avalon {
  ...
  public class SimEventHub {
    ...
    public IDisposable OnConfirmed<T>(Action<T> handler) where T : SimulationEvent => Add(_confirmed, handler);
    public IDisposable OnPredicted<T>(Action<T> handler) where T : SimulationEvent => Add(_predicted, handler);
    public IDisposable OnCanceled<T>(Action<T> handler) where T : SimulationEvent => Add(_canceled, handler);
